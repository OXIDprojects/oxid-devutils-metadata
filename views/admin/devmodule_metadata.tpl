[{include file="dev_header.tpl"}]
<form name="transfer" id="transfer" action="[{$oViewConf->getSelfLink()}]" method="post">
    [{$oViewConf->getHiddenSid()}]
    <input type="hidden" name="oxid" value="[{$oView->getEditObjectId()}]">
    <input type="hidden" name="cl" value="devmodule_metadata">
...
<script>
    [{capture assign="ng"}]
    var url = '[{$oViewConf->getSelfLink()|oxaddparams:"cl=devmodule_metadata&fnc=xxxxxx"|replace:"&amp;":"&"}]';
...
[{include file="dev_footer.tpl" b2t=false}]
